...
// ANSWER: You can not because you are looking for the same index every time, there is no way to change the time complexity in this case to be any better. We always need to search through array to find the fourth element.
...
// ANSWER - countLetters: Linear Space 0(n2)
// ANSWER - countLettersRoundTwo: Quadratic Space 0(n)


// Q: Explain how you came to your conclusions about the space complexity of each function. 
// ANSWER:  second function is creating new variable and storing info in multiple ways to find the same answers. It seems like the first function is just utilizing the exisitng arrays. I am probably wrong. This one was tought ointernalize and makes sense of.
